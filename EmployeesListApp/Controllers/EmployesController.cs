...
namespace EmployeesListApp.Controllers
{
    public class EmployesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Name,Position,Salary")] Employe employe)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Name,Position,Salary")] Employe employe)
        {
            if (ModelState.IsValid)
            {
